...
const ORDERS = (() => {
  ...
  return base.map((b, i) => ({
    ...
    date: '23.12.25',
    // дата формирования заказа — для хронологии в списках привязки/поиска
...
const SERVICE_KIND = {
  ...
  'Аэроэкспресс': { icon: 'zap',   color: '#d21b3c', tone: 'red' },
};
...
// Справочник кодов ошибок интеграций: сбои API поставщиков, GDS, платёжного шлюза и внутренние ошибки.
// Используется в центре уведомлений (source: 'Интеграции', поле errCode) и в Настройках → Параметры системы.
...
const SVC_DATA = {
  ...
  // Аэроэкспресс — доп. услуга. Тарифы флотовые (одинаковы для всех направлений),
  // отличаются вариацией проезда: разовый / туда-обратно / абонемент (как на крупных тревел-платформах).
  // Цены в ₽. fareType фильтрует выдачу под выбранную вкладку проезда.
  aero: {
    offers: [
      // --- Разовый (в одну сторону) ---
