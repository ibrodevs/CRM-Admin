        ...
        {view === 'results' && (
          <div className="fade-in">
            ...
            {loading
              ...
              : offers.map((o) => <SvcOfferCard key={o.id} o={o} kind={cfg.kind} onSelect={(x) => { setItem(x); setView('card'); toast('Услуга добавлена в заказ', 'ok'); }} onSave={() => toast('Предложение сохранено', 'ok')} />)}
          </div>
        )}
