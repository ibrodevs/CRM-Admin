...
test('bulk calculation is explicit and preserves every ticket tariff', () => {
  assert.match(fulfillment, /const \[bulkConfirm, setBulkConfirm\]/);
  assert.match(fulfillment, /<ConfirmDialog open=\{!!bulkConfirm\}/);
...
test('pricing table is responsive and rail documents have precise names', () => {
