...
import { COMPANY_STATUS, ORDERS, ORDER_STATUS, SETTLEMENT_TONE, companyBalanceShort, companyFinance } from '../../../legacy/data/index';
import { UnifiedPersonDrawer, ufBlankPerson, ufDateIso, ufFromClient } from '../../clients/ui/UnifiedForms';
...
import { PaxGroupsDrawer, PaxUnifyPanel, paxMergeAppend } from '../../clients/ui/PassengerTools';
import { TravelPolicyBlock } from './TravelPolicy';
import { CompanyFinanceBlock } from './CompanyFinance';
import { communicationsApi } from '../../../legacy/compatibility/resources';
import { toUiCompany } from '../../../legacy/adapters/ui-adapters';
import { resultsOf } from '../../../shared/api/client';
import { pUsd, ordersOf, orderDate } from '../../clients/model/people-helpers.js';
import { ordersForCompany, toUiDepartment, toUiEmployee } from '../model/people-helpers.js';
import { citizenshipCode, personPayloadFromUnified } from '../../clients/ui/ClientsPage.jsx';
