...
export const workforceApi = {
  ...
  shifts: (params = {}, signal) => listAll('shifts/', params, signal),
  ...
  motivationRules: (signal, userId, history = false) => get(`motivation/rules/${queryString({ ...(userId ? { user: userId } : {}), ...(history ? { history: 1 } : {}) })}`, signal),
