...
const CURRENCIES = [
  // Рубль первым: он же валюта по умолчанию, и в пустом select'е должен
  // предлагаться именно он, а не доллар.
...
const SERVICE_KIND = {
  ...
  'Аэроэкспресс': { icon: 'zap',   color: '#2566ff', tone: 'blue', img: 'assets/Express-blue-logo.png' },
...
if (!ENABLE_DEMO_BUSINESS_DATA) {
  [
    CLIENTS, OPERATORS, ORDERS, SUPPLIERS, FINANCE, DOCUMENTS, DASH_STATS, ORDER_BREAKDOWN,
